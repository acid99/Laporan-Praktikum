...
3. **Setup nginx pada debian_php5.6 untuk domain http://lxc_php5.dev , buat halaman index.html yang menerangkan informasi nama lxc**
    ...
    b. Menginstall package nano (untuk membuka dan mengedit konfigurasi), net-tools (untuk kebutuhan internet), dan curl (untuk mengecek konektivitas URL)
    ...
    #Me-link file konfigurasi lxc_php5.6.dev ke direktori sites-enabled
